...
export default function Hero() {
  return (
    <section
      className="relative overflow-hidden px-5 pb-20 pt-16 md:px-10 md:pb-28 md:pt-24"
      style={{
        backgroundImage: `url('/images/hero-bg-3.jpg')`, // your image path here
    ...
    >
      ...
      <div
        ...
        style={{ background: "linear-gradient(to bottom, transparent, rgba(248,247,255,1))" }}
      />
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <h1 className="sora mb-5 text-4xl font-black leading-[1.08] text-white md:text-6xl lg:text-7xl">
          Your next
          <br />
          <span className="text-[#ffd166]">adventure</span>
          <br />
          awaits
        </h1>
        ...
        <div className="flex flex-wrap gap-3">
          {CATEGORIES.map((cat) => (
            <button
              key={cat.label}
              className="flex items-center gap-2.5 rounded-2xl bg-white/12 px-5 py-3 text-sm font-medium text-white backdrop-blur-md transition hover:bg-white/22 hover:shadow-lg active:scale-95"
            >
