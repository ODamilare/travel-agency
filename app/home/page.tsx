  ...
  return (
   ...
   <Hero />
      ...
      <section className="bg-white px-5 py-14 md:px-10 md:py-18">
        <div className="mx-auto max-w-7xl">
          <div className="mb-8">
            <p className="mb-2 text-[11px] font-bold uppercase tracking-[0.2em] text-[#6c47ff]">Explore</p>
            <h2 className="sora text-2xl font-extrabold text-gray-900 md:text-3xl">Hotels in Popular Locations</h2>
          </div>
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
            {HOTELS.map((h) => (
              <div key={h.city} className="lift group relative cursor-pointer overflow-hidden rounded-3xl">
                <img src={h.img} alt={h.city} className="h-44 w-full object-cover transition duration-500 group-hover:scale-105 md:h-64" />
          ...
          <div className="mb-12 grid grid-cols-2 gap-8 md:grid-cols-4">
            ...
            <div>
              <Link href="/" className="mb-4 flex items-center gap-2.5">
                <Logo size={32} />
                <span className="sora text-sm font-bold tracking-widest text-gray-800">UXTRAVELERZ</span>
              </Link>
